...
import yovi.putra.moviecatalogue.core.utils.network.NetworkThrowable
...
import yovi.putra.moviecatalogue.ui.tvshow.list.TVShowAdapter
    ...
    private var tvShowObserve = Observer<ResultState> {
        when (it) {
            ...
            is ResultState.Error -> {
                contextView.toast(NetworkThrowable.errorMessage(contextView, it.error))
            }
        }
    }
